    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 md:px-10 py-10">
      <div className="flex flex-col md:flex-row md:items-start md:gap-10 gap-8">
        ...
        <div className="w-full md:w-2/3 space-y-4">
          ...
          <Link onClick={handleInstall} className=" btn bg-green-500 hover:bg-green-600 text-white px-6 py-3 rounded-xl font-semibold mt-5 transition w-full sm:w-auto">
            Install Now ({size} MB)
          </Link>
        </div>
      </div>
